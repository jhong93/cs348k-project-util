...
def main(video_dir):
    ...
    print('\nTotal: {:d} s  {:d} frames  {:d} videos'.format(
        int(total_seconds), total_frames, len(videos)))
    print('Estimated size as jpgs (height = 224): {:d} MB'.format(
        round(0.018 * total_frames)))
